...
export const IcArrowDownLeft = (p) => <S {...p}><path d="M17 7 7 17"/><path d="M17 17H7V7"/></S>
export const IcArrowUpRight = (p) => <S {...p}><path d="M7 17 17 7"/><path d="M7 7h10v10"/></S>
export const IcArrowSwap = (p) => <S {...p}><path d="m16 3 4 4-4 4"/><path d="M20 7H4"/><path d="m8 21-4-4 4-4"/><path d="M4 17h16"/></S>
...
export const IcDevice = (p) => <S {...p}><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></S>
